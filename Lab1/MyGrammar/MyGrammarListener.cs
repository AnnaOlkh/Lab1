...
public interface IMyGrammarListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMultiplicativeOrPowerExpression([NotNull] MyGrammarParser.MultiplicativeOrPowerExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>MultiplicativeOrPowerExpression</c>
	/// labeled alternative in <see cref="MyGrammarParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMultiplicativeOrPowerExpression([NotNull] MyGrammarParser.MultiplicativeOrPowerExpressionContext context);
	/// <summary>
