...
public partial class MyGrammarBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IMyGrammarVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>MultiplicativeOrPowerExpression</c>
	/// labeled alternative in <see cref="MyGrammarParser.expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMultiplicativeOrPowerExpression([NotNull] MyGrammarParser.MultiplicativeOrPowerExpressionContext context) { return VisitChildren(context); }
	/// <summary>
