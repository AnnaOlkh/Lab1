...
public partial class MyGrammarBaseListener : IMyGrammarListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>MultiplicativeOrPowerExpression</c>
	/// labeled alternative in <see cref="MyGrammarParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMultiplicativeOrPowerExpression([NotNull] MyGrammarParser.MultiplicativeOrPowerExpressionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>MultiplicativeOrPowerExpression</c>
	/// labeled alternative in <see cref="MyGrammarParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMultiplicativeOrPowerExpression([NotNull] MyGrammarParser.MultiplicativeOrPowerExpressionContext context) { }
	/// <summary>
